          ...
          <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;">
            ...
            <tr>
              <td style="padding:30px;background-color:#ffffff;">
                <h1 style="margin-top:0;margin-bottom:16px;font-size:26px;line-height:32px;font-weight:bold;letter-spacing:-0.02em;">Thank you for contacting us!</h1>
                <p style="margin:0;">
                ...
                <p>Our team will review your message and respond as soon as possible. In the meantime, please feel free to explore our website for more information about our services and offerings.</p>
            ...
            <tr>
              <td style="padding:30px;text-align:center;font-size:12px;background-color:#404040;color:#cccccc;">
                ...
                <p style="margin:0;font-size:14px;line-height:20px;">&reg; Ecoagro Zambia, Powered by Greenwebbtech 2023<br><a class="unsub" href="#" style="color:#cccccc;text-decoration:underline;">Unsubscribe instantly</a></p>
              </td>
            </tr>
          </table>
          <!--[if mso]>
