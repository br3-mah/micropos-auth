        ...
        <td align="center">
          ...
          <div class="outer" style="width:96%;max-width:660px;margin:20px auto;">
            ...
            <table role="presentation" style="width:100%;border:0;border-spacing:0;">
              ...
              <tr>
                <td style="padding:10px;text-align:left;">
                  <h1 style="margin-top:0;margin-bottom:16px;font-family:Arial,sans-serif;font-size:26px;line-height:32px;font-weight:bold;">Agricultural Services</h1>
                  <p style="margin:0;font-family:Arial,sans-serif;font-size:18px;line-height:24px;">
                    We're dedicated to pioneering innovative solutions and services that drive the agricultural industry towards a sustainable and prosperous future.</p>
                </td>
              </tr>
            </table>
            ...
            <div class="two-col" style="text-align:center;font-size:0;">
              ...
              <div class="column" style="width:100%;max-width:330px;display:inline-block;vertical-align:middle;">
                <div style="padding:10px;font-size:14px;line-height:18px;text-align:left;">
                  <p style="margin-top:0;margin-bottom:12px;font-family:Arial,sans-serif;font-weight:bold;">Learn More About Ecoagro & Agriculture</p>
                  <p style="margin-top:0;margin-bottom:14px;font-family:Arial,sans-serif;">Bridging the Gap with Professoinal tools & Agricultural Advisory Services</p>
                  <p style="margin:0;font-family:Arial,sans-serif;"><a href="#to_eco_website" style="background: #ffffff; border: 2px solid #8dc1d6; text-decoration: none; padding: 10px 25px; color: #000000; border-radius: 4px; display:inline-block; mso-padding-alt:0;text-underline-color:#ffffff"><!--[if mso]><i style="letter-spacing: 25px;mso-font-width:-100%;mso-text-raise:20pt">&nbsp;</i><![endif]--><span style="mso-text-raise:10pt;font-weight:bold;">Start Today</span><!--[if mso]><i style="letter-spacing: 25px;mso-font-width:-100%">&nbsp;</i><![endif]--></a></p>
                </div>
              </div>
              <!--[if mso]>
              </td>
            ...
            <div class="two-col" style="text-align:center;font-size:0;direction:rtl;">
              ...
              <div class="column" style="width:100%;max-width:330px;display:inline-block;vertical-align:middle;direction:ltr;">
                <div style="padding:10px;font-size:14px;line-height:18px;text-align:left;">
                  <p style="margin-top:0;margin-bottom:12px;font-family:Arial,sans-serif;font-weight:bold;">Agro Mareketplace</p>
                  <p style="margin-top:0;margin-bottom:14px;font-family:Arial,sans-serif;">EcoAgro's Agro Marketplace" is an innovative and comprehensive service offered within the ecoAgro platform, tailored specifically for agricultural and farming communities. This service is designed to revolutionize the way farmers, suppliers, and buyers interact, trade, and access agricultural products and services.</p>
                  <p style="margin:0;font-family:Arial,sans-serif;"><a href="#tosite" style="background: #ffffff; border: 2px solid #8dc1d6; text-decoration: none; padding: 10px 25px; color: #000000; border-radius: 4px; display:inline-block; mso-padding-alt:0;text-underline-color:#ffffff"><!--[if mso]><i style="letter-spacing: 25px;mso-font-width:-100%;mso-text-raise:20pt">&nbsp;</i><![endif]--><span style="mso-text-raise:10pt;font-weight:bold;">Lock it in</span><!--[if mso]><i style="letter-spacing: 25px;mso-font-width:-100%">&nbsp;</i><![endif]--></a></p>
                </div>
              </div>
              <!--[if mso]>
              </td>
            ...
            <div class="sidebar" style="font-size:0;text-align:center;direction:rtl;">
              ...
              <div class="large" style="width:100%;max-width:560px;display:inline-block;vertical-align:middle;direction:ltr;">
                <div style="padding:10px;font-size:14px;line-height:18px;">
                  <p style="margin:0;font-family:Arial,sans-serif;">We Help You Choose the Best for Solution Your Agro Needs ! <a href="http:localhost:8000/register?source=website&destination=website" style="color:#a16767;text-decoration:underline;"><strong>Register&nbsp;today</strong></a></p>
                </div>
              </div>
              <!--[if mso]>
              </td>
