    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <form method="POST" action="{{ route('category.store') }}" enctype="multipart/form-data" class="form d-flex flex-column flex-lg-row">
                    {{-- <form method="POST" action="{{ route('category.store') }}" enctype="multipart/form-data" id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row" data-kt-redirect="../../demo10/dist/apps/ecommerce/catalog/categories.html"> --}}
                    <!--begin::Aside column-->
                    @csrf
